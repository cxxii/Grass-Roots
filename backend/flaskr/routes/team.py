...
def update_team(team_id):
    ...
    if "name" in data:
        ...
        unique_name_id = Team.query.filter_by(name=new_name, league_id=team_data.league_id).all()
...
# ! BUGGY
@team.route("/api/v1/team/location/<string:location>/sport/<string:sport>", methods=["GET"])
